                  ...
                  <div className="pe-grid-layout">
                    ...
                    <div className="pe-card">
                      ...
                      <div className="pe-card-content">
                        ...
                        <div className="pe-input-group">
                          <input type="number" placeholder="0" value={ceilingArea} onChange={(e) => setCeilingArea(e.target.value)} />
                    ...
                    <div className="pe-card">
                      ...
                      <div className="pe-card-content">
                        ...
                        <div className="pe-input-group">
                          <input type="number" placeholder="0" value={wallArea} onChange={(e) => setWallArea(e.target.value)} />
                          <span className="pe-unit">m²</span>
                        </div>
                      </div>
                    </div>
